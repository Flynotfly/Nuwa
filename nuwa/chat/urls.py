...
from .views.character import CharaterListCreateView, CharacterRetrieveUpdateDestroyView
...
urlpatterns = [
    ...
    path("characters/<int:pk>", CharacterRetrieveUpdateDestroyView.as_view(), name="characters-detail"),
]
